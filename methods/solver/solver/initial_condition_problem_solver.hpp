#ifndef INITIAL_CONDITION_PROBLEM_SOLVER_HPP
#define INITIAL_CONDITION_PROBLEM_SOLVER_HPP
...
/**
    ...
    @see Solver_Concept
*/
class Initial_Condition_Problem_Solver {
        
    public:

        // some definitions.
        using Parameter = Initial_Condition_Problem_Solver_Parameter;
        using Result_Element = Initial_Condition_Problem_Solver_Result_Element;
        using Output_Element = Initial_Condition_Problem_Solver_Output_Element;
        ...
        */
        Initial_Condition_Problem_Solver (const Configuration& configuration) {
